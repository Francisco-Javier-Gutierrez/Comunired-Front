        ...
        <div className="w-75 min-vh-100 mx-auto home-container d-flex flex-column">
            <React.Fragment>
                <div className="d-flex my-3">
                    <div>
                        <img src={profilePictureUrl ?? "/Profile.svg"} alt={name ?? "Usuario"} className="cursor-pointer no-select rounded-circle me-1 user-image"
                    ...
                    <div className="text-white flex-grow-1">
                        ...
                        <p className="mb-1"><strong>Servicio:</strong> {ServiceNames[Servicio_reporte as ServiceCode] ?? null}</p>
                        <p className="mb-3">{Descripcion_problema}</p>

                        {Foto_evidencia && (<img src={Foto_evidencia} alt="evidencia"
